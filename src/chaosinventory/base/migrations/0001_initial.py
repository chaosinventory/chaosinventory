    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('note', models.TextField()),
                ('inventory_ids', models.ManyToManyField(to='base.InventoryId')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='base.location')),
            ],
        ),
        migrations.CreateModel(
            name='LocationData',
        ...
        migrations.AddField(
            model_name='item',
            name='inventory_ids',
            field=models.ManyToManyField(to='base.InventoryId'),
        ),
        migrations.AddField(
            model_name='item',
            name='product',
        ...
        migrations.AddField(
            model_name='inventoryid',
            name='schema',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='base.inventoryidschema'),
        ),
        migrations.CreateModel(
            name='EntityData',
            fields=[
